...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <form action="menuManage_addMenu.action" method="post" onsubmit="return validateFrm();">
    <table width="500" align="center" class="inputTable" style="margin-top:15px">
      ...
      <tr id="menuNameRow">
        <th>菜单名：</th>
        <td><input name="menu.name" class="text"/></td>
      </tr>
      <tr>
        <th>菜单类型：</th>
        <td>
      ...
      <tr id="actionRow" style="display:none">
        <th>菜单动作</th>
        <td><input name="menu.action.name" class="text" /></td>
      </tr>
      <tr>
        <th>菜单说明</th>
